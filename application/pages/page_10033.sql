...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(21943784103562978)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(21943881282562978)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(21943912251562978)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(21943784103562978)
,p_button_name=>'NEXT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(21945901389562979)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(21943784103562978)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(21947222599562981)
,p_branch_action=>'f?p=&APP_ID.:10034:&APP_SESSION.::&DEBUG.:RP,10034::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(21943912251562978)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(21947657948562981)
,p_name=>'P10033_ROLE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(21943881282562978)
,p_item_default=>'2'
,p_prompt=>'Roles'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(21948080283562981)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(21948423461562982)
...
,p_lov=>'.'||wwv_flow_imp.id(21948540597562982)||'.'
,p_field_template=>wwv_flow_imp.id(127893514922451536)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_attribute_01=>'1'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(21946035791562979)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(21945901389562979)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(21946780325562980)
,p_event_id=>wwv_flow_imp.id(21946035791562979)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(21949561911562983)
...
,p_process_when_button_id=>wwv_flow_imp.id(21943912251562978)
,p_internal_uid=>21949561911562983
);
