prompt --application/shared_components/plugins/template_component/theme_100_avatar
begin
--   Manifest
--     PLUGIN: THEME_100$AVATAR
--   Manifest End
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(127898076983451541)
,p_plugin_type=>'TEMPLATE COMPONENT'
,p_theme_id=>nvl(wwv_flow_application_install.get_theme_id, '100')
,p_name=>'THEME_100$AVATAR'
,p_display_name=>'Avatar'
,p_supported_component_types=>'PARTIAL'
,p_image_prefix => nvl(wwv_flow_application_install.get_static_plugin_file_prefix('TEMPLATE COMPONENT','THEME_100$AVATAR'),'')
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127898330905451542)
,p_plugin_id=>wwv_flow_imp.id(127898076983451541)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127898609210451543)
,p_plugin_attribute_id=>wwv_flow_imp.id(127898330905451542)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127899017908451543)
,p_plugin_attribute_id=>wwv_flow_imp.id(127898330905451542)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127899448495451544)
,p_plugin_attribute_id=>wwv_flow_imp.id(127898330905451542)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127899814646451544)
,p_plugin_id=>wwv_flow_imp.id(127898076983451541)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(127898330905451542)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127900171321451544)
,p_plugin_id=>wwv_flow_imp.id(127898076983451541)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(127899814646451544)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127900402725451545)
,p_plugin_id=>wwv_flow_imp.id(127898076983451541)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127900779476451545)
,p_plugin_id=>wwv_flow_imp.id(127898076983451541)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127901073810451545)
,p_plugin_id=>wwv_flow_imp.id(127898076983451541)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127901324735451545)
,p_plugin_attribute_id=>wwv_flow_imp.id(127901073810451545)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127901721600451546)
,p_plugin_attribute_id=>wwv_flow_imp.id(127901073810451545)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127902164556451546)
,p_plugin_attribute_id=>wwv_flow_imp.id(127901073810451545)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127902578802451546)
,p_plugin_id=>wwv_flow_imp.id(127898076983451541)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127902878854451547)
,p_plugin_attribute_id=>wwv_flow_imp.id(127902578802451546)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127903233232451547)
,p_plugin_attribute_id=>wwv_flow_imp.id(127902578802451546)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127903617116451547)
,p_plugin_attribute_id=>wwv_flow_imp.id(127902578802451546)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127904076281451547)
,p_plugin_attribute_id=>wwv_flow_imp.id(127902578802451546)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127904476251451548)
,p_plugin_attribute_id=>wwv_flow_imp.id(127902578802451546)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127904877644451548)
,p_plugin_attribute_id=>wwv_flow_imp.id(127902578802451546)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127905272386451548)
,p_plugin_attribute_id=>wwv_flow_imp.id(127902578802451546)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127905674912451549)
,p_plugin_id=>wwv_flow_imp.id(127898076983451541)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1949664985696127946)
,p_plugin_id=>wwv_flow_imp.id(127898076983451541)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
