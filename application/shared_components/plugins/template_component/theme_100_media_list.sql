prompt --application/shared_components/plugins/template_component/theme_100_media_list
begin
--   Manifest
--     PLUGIN: THEME_100$MEDIA_LIST
--   Manifest End
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(127947972586451595)
,p_plugin_type=>'TEMPLATE COMPONENT'
,p_theme_id=>nvl(wwv_flow_application_install.get_theme_id, '100')
,p_name=>'THEME_100$MEDIA_LIST'
,p_display_name=>'Media List'
,p_supported_component_types=>'PARTIAL:REPORT'
,p_image_prefix => nvl(wwv_flow_application_install.get_static_plugin_file_prefix('TEMPLATE COMPONENT','THEME_100$MEDIA_LIST'),'')
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1949731671838897942)
,p_plugin_id=>wwv_flow_imp.id(127947972586451595)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1949732226850897943)
,p_plugin_id=>wwv_flow_imp.id(127947972586451595)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127948640499451596)
,p_plugin_id=>wwv_flow_imp.id(127947972586451595)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127948941606451596)
,p_plugin_id=>wwv_flow_imp.id(127947972586451595)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127949248198451596)
,p_plugin_id=>wwv_flow_imp.id(127947972586451595)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127949569681451597)
,p_plugin_id=>wwv_flow_imp.id(127947972586451595)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127949845425451597)
,p_plugin_id=>wwv_flow_imp.id(127947972586451595)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(127949248198451596)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1949732226850897943)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127950132636451597)
,p_plugin_attribute_id=>wwv_flow_imp.id(127949845425451597)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127950562623451597)
,p_plugin_attribute_id=>wwv_flow_imp.id(127949845425451597)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127950904537451598)
,p_plugin_attribute_id=>wwv_flow_imp.id(127949845425451597)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127951342848451598)
,p_plugin_id=>wwv_flow_imp.id(127947972586451595)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(127949845425451597)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127951693676451598)
,p_plugin_id=>wwv_flow_imp.id(127947972586451595)
,p_attribute_scope=>'COMPONENT'
...
,p_depending_on_attribute_id=>wwv_flow_imp.id(127951342848451598)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127951951561451599)
,p_plugin_id=>wwv_flow_imp.id(127947972586451595)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127952277733451599)
,p_plugin_id=>wwv_flow_imp.id(127947972586451595)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127952575915451599)
,p_plugin_id=>wwv_flow_imp.id(127947972586451595)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127952850186451599)
,p_plugin_attribute_id=>wwv_flow_imp.id(127952575915451599)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127953210481451600)
,p_plugin_attribute_id=>wwv_flow_imp.id(127952575915451599)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127954068530451600)
,p_plugin_attribute_id=>wwv_flow_imp.id(127952575915451599)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127953626727451600)
,p_plugin_attribute_id=>wwv_flow_imp.id(127952575915451599)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127954459816451601)
,p_plugin_id=>wwv_flow_imp.id(127947972586451595)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(127949569681451597)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1949731671838897942)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127954724390451601)
,p_plugin_id=>wwv_flow_imp.id(127947972586451595)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127955088292451601)
,p_plugin_id=>wwv_flow_imp.id(127947972586451595)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127955307943451601)
,p_plugin_id=>wwv_flow_imp.id(127947972586451595)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127955690384451602)
,p_plugin_id=>wwv_flow_imp.id(127947972586451595)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127955949829451602)
,p_plugin_id=>wwv_flow_imp.id(127947972586451595)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127956276327451602)
,p_plugin_attribute_id=>wwv_flow_imp.id(127955949829451602)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127956662805451602)
,p_plugin_attribute_id=>wwv_flow_imp.id(127955949829451602)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127957019908451603)
,p_plugin_id=>wwv_flow_imp.id(127947972586451595)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127957330315451603)
,p_plugin_attribute_id=>wwv_flow_imp.id(127957019908451603)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127957751706451603)
,p_plugin_attribute_id=>wwv_flow_imp.id(127957019908451603)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127958170260451604)
,p_plugin_attribute_id=>wwv_flow_imp.id(127957019908451603)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127958523096451604)
,p_plugin_id=>wwv_flow_imp.id(127947972586451595)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127959261019451604)
,p_plugin_attribute_id=>wwv_flow_imp.id(127958523096451604)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127959645404451605)
,p_plugin_attribute_id=>wwv_flow_imp.id(127958523096451604)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127960047692451605)
,p_plugin_attribute_id=>wwv_flow_imp.id(127958523096451604)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127960482141451605)
,p_plugin_attribute_id=>wwv_flow_imp.id(127958523096451604)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127958805104451604)
,p_plugin_attribute_id=>wwv_flow_imp.id(127958523096451604)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127960868634451606)
,p_plugin_id=>wwv_flow_imp.id(127947972586451595)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127961125388451606)
,p_plugin_attribute_id=>wwv_flow_imp.id(127960868634451606)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127961587032451606)
,p_plugin_id=>wwv_flow_imp.id(127947972586451595)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1949935279008044571)
,p_plugin_id=>wwv_flow_imp.id(127947972586451595)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
