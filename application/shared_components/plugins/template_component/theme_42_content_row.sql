...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(21743411673562679)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1948981287261634375)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1948980732249634374)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21744123286562680)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21744451623562681)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21744779441562681)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21745024292562681)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21745326370562681)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21745691377562682)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21745918080562682)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(21745326370562681)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1948981287261634375)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21746205513562682)
,p_plugin_attribute_id=>wwv_flow_imp.id(21745918080562682)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21746601977562682)
,p_plugin_attribute_id=>wwv_flow_imp.id(21745918080562682)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21747084509562683)
,p_plugin_attribute_id=>wwv_flow_imp.id(21745918080562682)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21747488635562683)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(21745918080562682)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21747764592562683)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(21747488635562683)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21748073356562683)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21748307667562684)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21748691694562684)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21748935818562684)
,p_plugin_attribute_id=>wwv_flow_imp.id(21748691694562684)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21749367995562684)
,p_plugin_attribute_id=>wwv_flow_imp.id(21748691694562684)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21749741999562685)
,p_plugin_attribute_id=>wwv_flow_imp.id(21748691694562684)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21750108093562685)
,p_plugin_attribute_id=>wwv_flow_imp.id(21748691694562684)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21750558285562685)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(21745691377562682)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1948980732249634374)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21750828396562685)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21751139245562686)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21751435468562686)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21751727330562686)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21752008511562686)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21752347381562687)
,p_plugin_attribute_id=>wwv_flow_imp.id(21752008511562686)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21752707360562687)
,p_plugin_attribute_id=>wwv_flow_imp.id(21752008511562686)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21753116625562687)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21753497131562687)
,p_plugin_attribute_id=>wwv_flow_imp.id(21753116625562687)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21753817804562688)
,p_plugin_attribute_id=>wwv_flow_imp.id(21753116625562687)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21754206864562688)
,p_plugin_attribute_id=>wwv_flow_imp.id(21753116625562687)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21754621685562688)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21754999938562688)
,p_plugin_attribute_id=>wwv_flow_imp.id(21754621685562688)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21755367684562689)
,p_plugin_attribute_id=>wwv_flow_imp.id(21754621685562688)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21755728997562689)
,p_plugin_attribute_id=>wwv_flow_imp.id(21754621685562688)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21756183190562689)
,p_plugin_attribute_id=>wwv_flow_imp.id(21754621685562688)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21756572502562690)
,p_plugin_attribute_id=>wwv_flow_imp.id(21754621685562688)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21756930440562690)
,p_plugin_attribute_id=>wwv_flow_imp.id(21754621685562688)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21757325461562690)
,p_plugin_attribute_id=>wwv_flow_imp.id(21754621685562688)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21757743138562690)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21758011361562691)
,p_plugin_attribute_id=>wwv_flow_imp.id(21757743138562690)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21758405616562691)
,p_plugin_attribute_id=>wwv_flow_imp.id(21757743138562690)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21758808817562691)
,p_plugin_attribute_id=>wwv_flow_imp.id(21757743138562690)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21759223682562691)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21759543537562692)
,p_plugin_attribute_id=>wwv_flow_imp.id(21759223682562691)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21759953112562692)
,p_plugin_attribute_id=>wwv_flow_imp.id(21759223682562691)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21760317279562692)
,p_plugin_attribute_id=>wwv_flow_imp.id(21759223682562691)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21760741622562693)
,p_plugin_attribute_id=>wwv_flow_imp.id(21759223682562691)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21761162657562693)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1830195177477455989)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1830196436997460137)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1816601548803049256)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1817280849533132360)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1830193242410411003)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1830194575800424860)
,p_plugin_id=>wwv_flow_imp.id(21743411673562679)
