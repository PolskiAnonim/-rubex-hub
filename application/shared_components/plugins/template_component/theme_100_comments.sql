prompt --application/shared_components/plugins/template_component/theme_100_comments
begin
--   Manifest
--     PLUGIN: THEME_100$COMMENTS
--   Manifest End
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(127915551230451563)
,p_plugin_type=>'TEMPLATE COMPONENT'
,p_theme_id=>nvl(wwv_flow_application_install.get_theme_id, '100')
,p_name=>'THEME_100$COMMENTS'
,p_display_name=>'Comments'
,p_supported_component_types=>'PARTIAL:REPORT'
,p_image_prefix => nvl(wwv_flow_application_install.get_static_plugin_file_prefix('TEMPLATE COMPONENT','THEME_100$COMMENTS'),'')
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1949534537003045949)
,p_plugin_id=>wwv_flow_imp.id(127915551230451563)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127916059849451564)
,p_plugin_id=>wwv_flow_imp.id(127915551230451563)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127916390464451564)
,p_plugin_id=>wwv_flow_imp.id(127915551230451563)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127916660423451564)
,p_plugin_id=>wwv_flow_imp.id(127915551230451563)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127916919731451564)
,p_plugin_id=>wwv_flow_imp.id(127915551230451563)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127917248874451565)
,p_plugin_id=>wwv_flow_imp.id(127915551230451563)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(127921820073451568)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1949534537003045949)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127917588205451565)
,p_plugin_attribute_id=>wwv_flow_imp.id(127917248874451565)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127917975809451565)
,p_plugin_attribute_id=>wwv_flow_imp.id(127917248874451565)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127918368485451565)
,p_plugin_attribute_id=>wwv_flow_imp.id(127917248874451565)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127918784777451566)
,p_plugin_id=>wwv_flow_imp.id(127915551230451563)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(127917248874451565)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127919013520451566)
,p_plugin_id=>wwv_flow_imp.id(127915551230451563)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(127918784777451566)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127919357539451566)
,p_plugin_id=>wwv_flow_imp.id(127915551230451563)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127919602193451567)
,p_plugin_id=>wwv_flow_imp.id(127915551230451563)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127919918675451567)
,p_plugin_id=>wwv_flow_imp.id(127915551230451563)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127920222653451567)
,p_plugin_attribute_id=>wwv_flow_imp.id(127919918675451567)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127920617428451567)
,p_plugin_attribute_id=>wwv_flow_imp.id(127919918675451567)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127921084831451568)
,p_plugin_attribute_id=>wwv_flow_imp.id(127919918675451567)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127921476284451568)
,p_plugin_attribute_id=>wwv_flow_imp.id(127919918675451567)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127921820073451568)
,p_plugin_id=>wwv_flow_imp.id(127915551230451563)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127922152559451569)
,p_plugin_id=>wwv_flow_imp.id(127915551230451563)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127922430952451569)
,p_plugin_attribute_id=>wwv_flow_imp.id(127922152559451569)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127922809208451569)
,p_plugin_attribute_id=>wwv_flow_imp.id(127922152559451569)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127923238582451569)
,p_plugin_id=>wwv_flow_imp.id(127915551230451563)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1949667204436147452)
,p_plugin_id=>wwv_flow_imp.id(127915551230451563)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1949666612931139995)
,p_plugin_id=>wwv_flow_imp.id(127915551230451563)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1949722236601121874)
,p_plugin_id=>wwv_flow_imp.id(127915551230451563)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1949874454313992645)
,p_plugin_id=>wwv_flow_imp.id(127915551230451563)
