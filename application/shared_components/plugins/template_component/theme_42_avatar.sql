...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(21715994316562652)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21716258489562653)
,p_plugin_id=>wwv_flow_imp.id(21715994316562652)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21716512470562654)
,p_plugin_attribute_id=>wwv_flow_imp.id(21716258489562653)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21716906201562654)
,p_plugin_attribute_id=>wwv_flow_imp.id(21716258489562653)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21717300178562654)
,p_plugin_attribute_id=>wwv_flow_imp.id(21716258489562653)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21717731851562654)
,p_plugin_id=>wwv_flow_imp.id(21715994316562652)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(21716258489562653)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21718060008562655)
,p_plugin_id=>wwv_flow_imp.id(21715994316562652)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(21717731851562654)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21718327505562655)
,p_plugin_id=>wwv_flow_imp.id(21715994316562652)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21718639348562655)
,p_plugin_id=>wwv_flow_imp.id(21715994316562652)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21718946175562655)
,p_plugin_id=>wwv_flow_imp.id(21715994316562652)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21719263302562656)
,p_plugin_attribute_id=>wwv_flow_imp.id(21718946175562655)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21719604412562656)
,p_plugin_attribute_id=>wwv_flow_imp.id(21718946175562655)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21720035761562656)
,p_plugin_attribute_id=>wwv_flow_imp.id(21718946175562655)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21720431032562657)
,p_plugin_id=>wwv_flow_imp.id(21715994316562652)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21720703657562657)
,p_plugin_attribute_id=>wwv_flow_imp.id(21720431032562657)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21721142502562657)
,p_plugin_attribute_id=>wwv_flow_imp.id(21720431032562657)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21721589061562657)
,p_plugin_attribute_id=>wwv_flow_imp.id(21720431032562657)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21721956564562658)
,p_plugin_attribute_id=>wwv_flow_imp.id(21720431032562657)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21722393411562658)
,p_plugin_attribute_id=>wwv_flow_imp.id(21720431032562657)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21722759512562658)
,p_plugin_attribute_id=>wwv_flow_imp.id(21720431032562657)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21723109506562658)
,p_plugin_attribute_id=>wwv_flow_imp.id(21720431032562657)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21723506389562659)
,p_plugin_id=>wwv_flow_imp.id(21715994316562652)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1821766804969676404)
,p_plugin_id=>wwv_flow_imp.id(21715994316562652)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
