prompt --application/shared_components/plugins/template_component/theme_100_button
begin
--   Manifest
--     PLUGIN: THEME_100$BUTTON
--   Manifest End
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(127912882257451559)
,p_plugin_type=>'TEMPLATE COMPONENT'
,p_theme_id=>nvl(wwv_flow_application_install.get_theme_id, '100')
,p_name=>'THEME_100$BUTTON'
,p_display_name=>'Button'
,p_image_prefix => nvl(wwv_flow_application_install.get_static_plugin_file_prefix('TEMPLATE COMPONENT','THEME_100$BUTTON'),'')
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127913137560451560)
,p_plugin_id=>wwv_flow_imp.id(127912882257451559)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127913481272451560)
,p_plugin_id=>wwv_flow_imp.id(127912882257451559)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127913783735451560)
,p_plugin_id=>wwv_flow_imp.id(127912882257451559)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127914072403451560)
,p_plugin_id=>wwv_flow_imp.id(127912882257451559)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127914346799451561)
,p_plugin_id=>wwv_flow_imp.id(127912882257451559)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127914667919451561)
,p_plugin_id=>wwv_flow_imp.id(127912882257451559)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127914952795451561)
,p_plugin_id=>wwv_flow_imp.id(127912882257451559)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127915242861451562)
,p_plugin_id=>wwv_flow_imp.id(127912882257451559)
,p_attribute_scope=>'COMPONENT'
