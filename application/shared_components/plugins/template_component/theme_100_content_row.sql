prompt --application/shared_components/plugins/template_component/theme_100_content_row
begin
--   Manifest
--     PLUGIN: THEME_100$CONTENT_ROW
--   Manifest End
...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(127925528943451573)
,p_plugin_type=>'TEMPLATE COMPONENT'
,p_theme_id=>nvl(wwv_flow_application_install.get_theme_id, '100')
,p_name=>'THEME_100$CONTENT_ROW'
,p_display_name=>'Content Row'
,p_supported_component_types=>'PARTIAL:REPORT'
,p_image_prefix => nvl(wwv_flow_application_install.get_static_plugin_file_prefix('TEMPLATE COMPONENT','THEME_100$CONTENT_ROW'),'')
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2076906970614085948)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2076906415602085947)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127926221737451574)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127926533708451575)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127926828844451575)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127927183733451575)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127927468146451575)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127927784144451576)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127928065128451576)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(127927468146451575)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2076906970614085948)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127928384169451576)
,p_plugin_attribute_id=>wwv_flow_imp.id(127928065128451576)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127928782040451576)
,p_plugin_attribute_id=>wwv_flow_imp.id(127928065128451576)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127929111235451577)
,p_plugin_attribute_id=>wwv_flow_imp.id(127928065128451576)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127929564648451577)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(127928065128451576)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127929817210451577)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(127929564648451577)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127930156195451578)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127930449499451578)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127930791256451578)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127931096328451578)
,p_plugin_attribute_id=>wwv_flow_imp.id(127930791256451578)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127931404082451579)
,p_plugin_attribute_id=>wwv_flow_imp.id(127930791256451578)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127931846727451579)
,p_plugin_attribute_id=>wwv_flow_imp.id(127930791256451578)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127932280953451579)
,p_plugin_attribute_id=>wwv_flow_imp.id(127930791256451578)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127932637611451580)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(127927784144451576)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2076906415602085947)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127932950691451580)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127933294147451580)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127933503978451580)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127933838131451581)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127934198973451581)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127934482334451581)
,p_plugin_attribute_id=>wwv_flow_imp.id(127934198973451581)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127934823373451582)
,p_plugin_attribute_id=>wwv_flow_imp.id(127934198973451581)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127935226610451582)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127935539172451582)
,p_plugin_attribute_id=>wwv_flow_imp.id(127935226610451582)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127935993519451582)
,p_plugin_attribute_id=>wwv_flow_imp.id(127935226610451582)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127936393931451583)
,p_plugin_attribute_id=>wwv_flow_imp.id(127935226610451582)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127936729745451583)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127937026146451583)
,p_plugin_attribute_id=>wwv_flow_imp.id(127936729745451583)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127937499512451584)
,p_plugin_attribute_id=>wwv_flow_imp.id(127936729745451583)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127937888548451584)
,p_plugin_attribute_id=>wwv_flow_imp.id(127936729745451583)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127938289734451584)
,p_plugin_attribute_id=>wwv_flow_imp.id(127936729745451583)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127938663537451585)
,p_plugin_attribute_id=>wwv_flow_imp.id(127936729745451583)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127939032941451585)
,p_plugin_attribute_id=>wwv_flow_imp.id(127936729745451583)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127939489298451585)
,p_plugin_attribute_id=>wwv_flow_imp.id(127936729745451583)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127939863067451586)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127940157811451586)
,p_plugin_attribute_id=>wwv_flow_imp.id(127939863067451586)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127940558716451586)
,p_plugin_attribute_id=>wwv_flow_imp.id(127939863067451586)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127940952432451586)
,p_plugin_attribute_id=>wwv_flow_imp.id(127939863067451586)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127941366688451587)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127941699714451587)
,p_plugin_attribute_id=>wwv_flow_imp.id(127941366688451587)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127942056953451587)
,p_plugin_attribute_id=>wwv_flow_imp.id(127941366688451587)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127942473166451588)
,p_plugin_attribute_id=>wwv_flow_imp.id(127941366688451587)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(127942835619451588)
,p_plugin_attribute_id=>wwv_flow_imp.id(127941366688451587)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(127943250836451588)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1958120860829907562)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1958122120349911710)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1944527232155500829)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1945206532885583933)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1958118925762862576)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1958120259152876433)
,p_plugin_id=>wwv_flow_imp.id(127925528943451573)
