...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(21765894939562699)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1821783639763446347)
,p_plugin_id=>wwv_flow_imp.id(21765894939562699)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1821784194775446348)
,p_plugin_id=>wwv_flow_imp.id(21765894939562699)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21766574179562699)
,p_plugin_id=>wwv_flow_imp.id(21765894939562699)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21766803290562700)
,p_plugin_id=>wwv_flow_imp.id(21765894939562699)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21767150787562700)
,p_plugin_id=>wwv_flow_imp.id(21765894939562699)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21767489108562700)
,p_plugin_id=>wwv_flow_imp.id(21765894939562699)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21767740661562700)
,p_plugin_id=>wwv_flow_imp.id(21765894939562699)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(21767150787562700)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1821784194775446348)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21768097713562700)
,p_plugin_attribute_id=>wwv_flow_imp.id(21767740661562700)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21768493892562701)
,p_plugin_attribute_id=>wwv_flow_imp.id(21767740661562700)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21768845434562701)
,p_plugin_attribute_id=>wwv_flow_imp.id(21767740661562700)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21769262472562701)
,p_plugin_id=>wwv_flow_imp.id(21765894939562699)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(21767740661562700)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21769539751562702)
,p_plugin_id=>wwv_flow_imp.id(21765894939562699)
,p_attribute_scope=>'COMPONENT'
...
,p_depending_on_attribute_id=>wwv_flow_imp.id(21769262472562701)
,p_depending_on_has_to_exist=>true
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21769832043562702)
,p_plugin_id=>wwv_flow_imp.id(21765894939562699)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21770131341562702)
,p_plugin_id=>wwv_flow_imp.id(21765894939562699)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21770439216562702)
,p_plugin_id=>wwv_flow_imp.id(21765894939562699)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21770753814562702)
,p_plugin_attribute_id=>wwv_flow_imp.id(21770439216562702)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21771161183562703)
,p_plugin_attribute_id=>wwv_flow_imp.id(21770439216562702)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21771540427562703)
,p_plugin_attribute_id=>wwv_flow_imp.id(21770439216562702)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21771977123562703)
,p_plugin_attribute_id=>wwv_flow_imp.id(21770439216562702)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21772362839562704)
,p_plugin_id=>wwv_flow_imp.id(21765894939562699)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(21767489108562700)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1821783639763446347)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21772690986562704)
,p_plugin_id=>wwv_flow_imp.id(21765894939562699)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21772985804562704)
,p_plugin_id=>wwv_flow_imp.id(21765894939562699)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21773264269562704)
,p_plugin_id=>wwv_flow_imp.id(21765894939562699)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21773541592562704)
,p_plugin_id=>wwv_flow_imp.id(21765894939562699)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21773892779562705)
,p_plugin_id=>wwv_flow_imp.id(21765894939562699)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21774184139562705)
,p_plugin_attribute_id=>wwv_flow_imp.id(21773892779562705)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21774563605562705)
,p_plugin_attribute_id=>wwv_flow_imp.id(21773892779562705)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21774971146562705)
,p_plugin_id=>wwv_flow_imp.id(21765894939562699)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21775231085562706)
,p_plugin_attribute_id=>wwv_flow_imp.id(21774971146562705)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21775621364562706)
,p_plugin_attribute_id=>wwv_flow_imp.id(21774971146562705)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21776061675562706)
,p_plugin_attribute_id=>wwv_flow_imp.id(21774971146562705)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21776486924562707)
,p_plugin_id=>wwv_flow_imp.id(21765894939562699)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21776771655562707)
,p_plugin_attribute_id=>wwv_flow_imp.id(21776486924562707)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21777182771562707)
,p_plugin_attribute_id=>wwv_flow_imp.id(21776486924562707)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21777523574562707)
,p_plugin_attribute_id=>wwv_flow_imp.id(21776486924562707)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21777960119562708)
,p_plugin_attribute_id=>wwv_flow_imp.id(21776486924562707)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21778380575562708)
,p_plugin_attribute_id=>wwv_flow_imp.id(21776486924562707)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21778776279562708)
,p_plugin_id=>wwv_flow_imp.id(21765894939562699)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(21779012485562708)
,p_plugin_attribute_id=>wwv_flow_imp.id(21778776279562708)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21779461253562709)
,p_plugin_id=>wwv_flow_imp.id(21765894939562699)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1821987246932592976)
,p_plugin_id=>wwv_flow_imp.id(21765894939562699)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
