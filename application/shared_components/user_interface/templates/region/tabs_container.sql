...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(21645540615562598)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21645892317562598)
,p_plug_template_id=>wwv_flow_imp.id(21645540615562598)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21646190103562598)
,p_plug_template_id=>wwv_flow_imp.id(21645540615562598)
,p_name=>'Tabs'
