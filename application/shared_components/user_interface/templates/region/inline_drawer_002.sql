prompt --application/shared_components/user_interface/templates/region/inline_drawer_002
begin
--   Manifest
...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(127761884910451427)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127762171966451427)
,p_plug_template_id=>wwv_flow_imp.id(127761884910451427)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127762436562451427)
,p_plug_template_id=>wwv_flow_imp.id(127761884910451427)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127762762887451427)
,p_plug_template_id=>wwv_flow_imp.id(127761884910451427)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127763064999451428)
,p_plug_template_id=>wwv_flow_imp.id(127761884910451427)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127763363818451428)
,p_plug_template_id=>wwv_flow_imp.id(127761884910451427)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127763659725451428)
,p_plug_template_id=>wwv_flow_imp.id(127761884910451427)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127763902143451428)
,p_plug_template_id=>wwv_flow_imp.id(127761884910451427)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127764290930451428)
,p_plug_template_id=>wwv_flow_imp.id(127761884910451427)
,p_name=>'Sub Regions'
