...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(21577252868562549)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21577511984562550)
,p_plug_template_id=>wwv_flow_imp.id(21577252868562549)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21577851279562550)
,p_plug_template_id=>wwv_flow_imp.id(21577252868562549)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21578156569562550)
,p_plug_template_id=>wwv_flow_imp.id(21577252868562549)
,p_name=>'Button Start'
