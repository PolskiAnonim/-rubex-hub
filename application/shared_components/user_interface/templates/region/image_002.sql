prompt --application/shared_components/user_interface/templates/region/image_002
begin
--   Manifest
...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(127766495747451431)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127766767549451431)
,p_plug_template_id=>wwv_flow_imp.id(127766495747451431)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127767072042451431)
,p_plug_template_id=>wwv_flow_imp.id(127766495747451431)
,p_name=>'Sub Regions'
