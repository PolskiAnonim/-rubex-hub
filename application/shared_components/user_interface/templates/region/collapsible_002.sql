prompt --application/shared_components/user_interface/templates/region/collapsible_002
begin
--   Manifest
...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(127797783822451456)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127798027597451456)
,p_plug_template_id=>wwv_flow_imp.id(127797783822451456)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127798328991451456)
,p_plug_template_id=>wwv_flow_imp.id(127797783822451456)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127798665409451456)
,p_plug_template_id=>wwv_flow_imp.id(127797783822451456)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127798902213451456)
,p_plug_template_id=>wwv_flow_imp.id(127797783822451456)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127799283714451457)
,p_plug_template_id=>wwv_flow_imp.id(127797783822451456)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127799586011451457)
,p_plug_template_id=>wwv_flow_imp.id(127797783822451456)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127799874336451457)
,p_plug_template_id=>wwv_flow_imp.id(127797783822451456)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127800125322451457)
,p_plug_template_id=>wwv_flow_imp.id(127797783822451456)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127800465661451458)
,p_plug_template_id=>wwv_flow_imp.id(127797783822451456)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127800729665451458)
,p_plug_template_id=>wwv_flow_imp.id(127797783822451456)
,p_name=>'Sub Regions'
