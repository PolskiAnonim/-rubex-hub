...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(21615637760562577)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21615917057562577)
,p_plug_template_id=>wwv_flow_imp.id(21615637760562577)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21616228453562577)
,p_plug_template_id=>wwv_flow_imp.id(21615637760562577)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21616523417562577)
,p_plug_template_id=>wwv_flow_imp.id(21615637760562577)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21616875082562578)
,p_plug_template_id=>wwv_flow_imp.id(21615637760562577)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21617163648562578)
,p_plug_template_id=>wwv_flow_imp.id(21615637760562577)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21617457992562578)
,p_plug_template_id=>wwv_flow_imp.id(21615637760562577)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21617711867562578)
,p_plug_template_id=>wwv_flow_imp.id(21615637760562577)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21618024993562578)
,p_plug_template_id=>wwv_flow_imp.id(21615637760562577)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21618314103562578)
,p_plug_template_id=>wwv_flow_imp.id(21615637760562577)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21618668011562579)
,p_plug_template_id=>wwv_flow_imp.id(21615637760562577)
,p_name=>'Sub Regions'
