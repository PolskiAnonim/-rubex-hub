...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(21574585920562548)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21574843962562548)
,p_plug_template_id=>wwv_flow_imp.id(21574585920562548)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21575165083562548)
,p_plug_template_id=>wwv_flow_imp.id(21574585920562548)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21575448508562548)
,p_plug_template_id=>wwv_flow_imp.id(21574585920562548)
,p_name=>'Sub Regions'
