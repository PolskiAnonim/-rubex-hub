prompt --application/shared_components/user_interface/templates/region/hero_002
begin
--   Manifest
...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(127812503110451467)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127812803268451468)
,p_plug_template_id=>wwv_flow_imp.id(127812503110451467)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127813152396451468)
,p_plug_template_id=>wwv_flow_imp.id(127812503110451467)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127813466900451468)
,p_plug_template_id=>wwv_flow_imp.id(127812503110451467)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127813799738451468)
,p_plug_template_id=>wwv_flow_imp.id(127812503110451467)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127814025013451469)
,p_plug_template_id=>wwv_flow_imp.id(127812503110451467)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
