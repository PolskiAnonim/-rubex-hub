...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(21584338101562554)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21584685309562555)
,p_plug_template_id=>wwv_flow_imp.id(21584338101562554)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21584984135562555)
,p_plug_template_id=>wwv_flow_imp.id(21584338101562554)
,p_name=>'Sub Regions'
