prompt --application/shared_components/user_interface/templates/region/item_container_002
begin
--   Manifest
...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(127759329521451425)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127759657813451425)
,p_plug_template_id=>wwv_flow_imp.id(127759329521451425)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127759939343451425)
,p_plug_template_id=>wwv_flow_imp.id(127759329521451425)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127760213364451425)
,p_plug_template_id=>wwv_flow_imp.id(127759329521451425)
,p_name=>'Button Start'
