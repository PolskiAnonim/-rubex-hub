...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(21633999357562590)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21634218462562590)
,p_plug_template_id=>wwv_flow_imp.id(21633999357562590)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21634506811562590)
,p_plug_template_id=>wwv_flow_imp.id(21633999357562590)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21634861417562590)
,p_plug_template_id=>wwv_flow_imp.id(21633999357562590)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21635134605562590)
,p_plug_template_id=>wwv_flow_imp.id(21633999357562590)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21635444191562591)
,p_plug_template_id=>wwv_flow_imp.id(21633999357562590)
,p_name=>'Sub Regions'
