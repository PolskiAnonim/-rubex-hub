...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(21610521634562573)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21610873410562573)
,p_plug_template_id=>wwv_flow_imp.id(21610521634562573)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21611141799562574)
,p_plug_template_id=>wwv_flow_imp.id(21610521634562573)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21611467221562574)
,p_plug_template_id=>wwv_flow_imp.id(21610521634562573)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21611779813562574)
,p_plug_template_id=>wwv_flow_imp.id(21610521634562573)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21612027134562574)
,p_plug_template_id=>wwv_flow_imp.id(21610521634562573)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21612338768562574)
,p_plug_template_id=>wwv_flow_imp.id(21610521634562573)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21612638781562575)
,p_plug_template_id=>wwv_flow_imp.id(21610521634562573)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21612909284562575)
,p_plug_template_id=>wwv_flow_imp.id(21610521634562573)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21613219714562575)
,p_plug_template_id=>wwv_flow_imp.id(21610521634562573)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21613577830562575)
,p_plug_template_id=>wwv_flow_imp.id(21610521634562573)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21613814575562575)
,p_plug_template_id=>wwv_flow_imp.id(21610521634562573)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21614194309562575)
,p_plug_template_id=>wwv_flow_imp.id(21610521634562573)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21614425357562576)
,p_plug_template_id=>wwv_flow_imp.id(21610521634562573)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
