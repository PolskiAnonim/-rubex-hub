...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(21594952263562562)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21595215505562562)
,p_plug_template_id=>wwv_flow_imp.id(21594952263562562)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21595591956562563)
,p_plug_template_id=>wwv_flow_imp.id(21594952263562562)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21595829866562563)
,p_plug_template_id=>wwv_flow_imp.id(21594952263562562)
,p_name=>'Sub Regions'
