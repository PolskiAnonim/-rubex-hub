...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(21579767033562551)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21580047703562552)
,p_plug_template_id=>wwv_flow_imp.id(21579767033562551)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21580337086562552)
,p_plug_template_id=>wwv_flow_imp.id(21579767033562551)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21580690874562552)
,p_plug_template_id=>wwv_flow_imp.id(21579767033562551)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21580986929562552)
,p_plug_template_id=>wwv_flow_imp.id(21579767033562551)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21581253093562552)
,p_plug_template_id=>wwv_flow_imp.id(21579767033562551)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21581540045562552)
,p_plug_template_id=>wwv_flow_imp.id(21579767033562551)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21581801231562553)
,p_plug_template_id=>wwv_flow_imp.id(21579767033562551)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21582188122562553)
,p_plug_template_id=>wwv_flow_imp.id(21579767033562551)
,p_name=>'Sub Regions'
