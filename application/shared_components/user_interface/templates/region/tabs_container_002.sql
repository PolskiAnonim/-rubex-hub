prompt --application/shared_components/user_interface/templates/region/tabs_container_002
begin
--   Manifest
...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(127827619468451479)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127827972982451480)
,p_plug_template_id=>wwv_flow_imp.id(127827619468451479)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127828258734451480)
,p_plug_template_id=>wwv_flow_imp.id(127827619468451479)
,p_name=>'Tabs'
