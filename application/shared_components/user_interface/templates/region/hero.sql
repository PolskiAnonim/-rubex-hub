...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(21630476279562587)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21630739541562587)
,p_plug_template_id=>wwv_flow_imp.id(21630476279562587)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21631086802562587)
,p_plug_template_id=>wwv_flow_imp.id(21630476279562587)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21631357209562588)
,p_plug_template_id=>wwv_flow_imp.id(21630476279562587)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21631626153562588)
,p_plug_template_id=>wwv_flow_imp.id(21630476279562587)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21631988471562588)
,p_plug_template_id=>wwv_flow_imp.id(21630476279562587)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
