prompt --application/shared_components/user_interface/templates/region/login_002
begin
--   Manifest
...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(127816094500451470)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127816317264451470)
,p_plug_template_id=>wwv_flow_imp.id(127816094500451470)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127816642541451471)
,p_plug_template_id=>wwv_flow_imp.id(127816094500451470)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127816960045451471)
,p_plug_template_id=>wwv_flow_imp.id(127816094500451470)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127817208716451471)
,p_plug_template_id=>wwv_flow_imp.id(127816094500451470)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127817559524451471)
,p_plug_template_id=>wwv_flow_imp.id(127816094500451470)
,p_name=>'Sub Regions'
