...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(21538271814562521)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21538581220562521)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21538824018562522)
,p_page_template_id=>wwv_flow_imp.id(21538271814562521)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(21539109510562522)
,p_page_template_id=>wwv_flow_imp.id(21538271814562521)
