...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(127727297314451398)
,p_theme_id=>100
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127727518680451398)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127727873479451399)
,p_page_template_id=>wwv_flow_imp.id(127727297314451398)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127728129426451399)
,p_page_template_id=>wwv_flow_imp.id(127727297314451398)
