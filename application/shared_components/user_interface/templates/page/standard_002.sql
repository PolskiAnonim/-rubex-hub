prompt --application/shared_components/user_interface/templates/page/standard_002
begin
--   Manifest
--     TEMPLATE: STANDARD
--   Manifest End
...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(127747637098451415)
,p_theme_id=>100
,p_name=>'Standard'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127747955330451415)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127748282204451415)
,p_page_template_id=>wwv_flow_imp.id(127747637098451415)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127748589569451415)
,p_page_template_id=>wwv_flow_imp.id(127747637098451415)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127748891116451416)
,p_page_template_id=>wwv_flow_imp.id(127747637098451415)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127749188059451416)
,p_page_template_id=>wwv_flow_imp.id(127747637098451415)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127749447188451416)
,p_page_template_id=>wwv_flow_imp.id(127747637098451415)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127749713373451416)
,p_page_template_id=>wwv_flow_imp.id(127747637098451415)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127750051921451416)
,p_page_template_id=>wwv_flow_imp.id(127747637098451415)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127750395019451417)
,p_page_template_id=>wwv_flow_imp.id(127747637098451415)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127750673349451417)
,p_page_template_id=>wwv_flow_imp.id(127747637098451415)
