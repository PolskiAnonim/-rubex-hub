prompt --application/shared_components/user_interface/templates/page/left_side_column_002
begin
--   Manifest
...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(127732811418451403)
,p_theme_id=>100
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127733160120451403)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127733446075451404)
,p_page_template_id=>wwv_flow_imp.id(127732811418451403)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127733726851451404)
,p_page_template_id=>wwv_flow_imp.id(127732811418451403)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127734081165451404)
,p_page_template_id=>wwv_flow_imp.id(127732811418451403)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127734379704451404)
,p_page_template_id=>wwv_flow_imp.id(127732811418451403)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127734617950451404)
,p_page_template_id=>wwv_flow_imp.id(127732811418451403)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127734924692451405)
,p_page_template_id=>wwv_flow_imp.id(127732811418451403)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127735230994451405)
,p_page_template_id=>wwv_flow_imp.id(127732811418451403)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127735547107451405)
,p_page_template_id=>wwv_flow_imp.id(127732811418451403)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127735864377451405)
,p_page_template_id=>wwv_flow_imp.id(127732811418451403)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127736199092451405)
,p_page_template_id=>wwv_flow_imp.id(127732811418451403)
