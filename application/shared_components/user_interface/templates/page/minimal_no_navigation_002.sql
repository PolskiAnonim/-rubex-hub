prompt --application/shared_components/user_interface/templates/page/minimal_no_navigation_002
begin
--   Manifest
...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(127744225231451412)
,p_theme_id=>100
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127744535965451412)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127744877263451412)
,p_page_template_id=>wwv_flow_imp.id(127744225231451412)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127745197175451413)
,p_page_template_id=>wwv_flow_imp.id(127744225231451412)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127745456015451413)
,p_page_template_id=>wwv_flow_imp.id(127744225231451412)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127745777605451413)
,p_page_template_id=>wwv_flow_imp.id(127744225231451412)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127746079579451413)
,p_page_template_id=>wwv_flow_imp.id(127744225231451412)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127746317128451414)
,p_page_template_id=>wwv_flow_imp.id(127744225231451412)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127746625516451414)
,p_page_template_id=>wwv_flow_imp.id(127744225231451412)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127746908660451414)
,p_page_template_id=>wwv_flow_imp.id(127744225231451412)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(127747263947451414)
,p_page_template_id=>wwv_flow_imp.id(127744225231451412)
